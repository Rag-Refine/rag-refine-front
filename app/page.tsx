...
const GlassPanel = ({
  ...
  <div
    className={`bg-surface-lowest/60 backdrop-blur-xl border border-white/5 rounded-2xl ${className}`}
  >
    {children}
  </div>
);
...
function ConfidenceBadge({ level }: { level: "high" | "medium" | "low" }) {
  ...
  return (
    <span
      className={`text-[10px] font-bold px-1.5 py-0.5 rounded border ${styles[level]} whitespace-nowrap`}
    >
      {labels[level]}
    </span>
  );
    ...
    <div className="w-full max-w-md">
      <GlassPanel className="p-6 border-primary/20 shadow-[0_0_24px_rgba(173,198,255,0.12)]">
        ...
        <p className="text-sm text-on-surface-variant mb-5">
          500 pages free. No credit card required.
        </p>
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-sans selection:bg-primary/30">
      ...
      <main className="pt-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-on-surface-variant max-w-xl leading-relaxed">
                RAG-Refine is the first ingestion platform that{" "}
                <strong className="text-on-surface">
                  audits document integrity
                </strong>{" "}
                for your AI Agents. Don&apos;t just parse PDFs—verify them with
                AI-powered confidence scoring and 99.9% data fidelity.
              </p>
                  ...
                  <div className="font-mono text-sm space-y-3">
                    ...
                    <div className="flex items-start gap-3 bg-amber-500/5 border border-amber-500/15 rounded-lg px-2 py-1.5">
                      <div className="flex-1 text-amber-200/80 text-xs leading-relaxed">
                        ...
                        <span className="bg-amber-400/20 px-0.5 rounded">
                          preceding 12 [months?]
                        </span>{" "}
                        period.
                      </div>
                    ...
                    <div className="flex items-start gap-3 bg-red-500/5 border border-red-500/15 rounded-lg px-2 py-1.5">
                      <div className="flex-1 text-red-300/80 text-xs leading-relaxed">
                        <span className="bg-red-400/20 px-0.5 rounded">
                          Table 3-B [layout ambiguous — 4 cols merged]
                        </span>
                      </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="flex-1 text-on-surface-variant text-xs">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-lg text-on-surface-variant leading-relaxed">
                  Every table and paragraph extracted receives a real-time
                  reliability score. Our engine identifies ambiguous layouts and
                  potential{" "}
                  <strong className="text-on-surface">
                    hallucination triggers
                  </strong>{" "}
                  before they reach your Vector Database.
                </p>
                <ul className="space-y-4 text-sm text-on-surface-variant">
                  {[
                    {
                      icon: CheckCircle2,
                      text: "Per-block confidence scores on every extraction",
                      color: "text-emerald-400",
                    },
                    {
                      icon: AlertTriangle,
                      text: "Automatic flagging of merged cells and ambiguous layouts",
                      color: "text-amber-400",
                    },
                    {
                      icon: Shield,
                      text: "Pre-vectorization hallucination risk report",
                      color: "text-primary",
                    },
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <GlassPanel className="p-0 overflow-hidden shadow-2xl">
                  <div className="flex items-center justify-between px-4 py-2 bg-surface-high border-b border-white/5">
                    <span className="text-xs font-mono text-slate-400">
                      Split-View Audit — legal_contract_v3.pdf
                    </span>
                    <div className="flex gap-1.5">
                      ...
                      <div className="mt-3 border border-amber-500/30 bg-amber-500/5 rounded p-2">
                        <div className="grid grid-cols-3 gap-1">
                          {Array.from({ length: 9 }).map((_, i) => (
                            <div
                              key={i}
                              className="h-2 bg-amber-500/20 rounded"
                            />
                          ))}
                        </div>
              ...
              >
                ...
                <p className="text-lg text-on-surface-variant leading-relaxed">
                  For mission-critical documents in Legal, Finance, or
                  Healthcare, &ldquo;close enough&rdquo; isn&apos;t enough. Use
                  our split-view editor to visually verify extraction against
                  the original PDF. Audit every token with full coordinate
                  mapping.
                </p>
                <ul className="space-y-4 text-sm text-on-surface-variant">
                  {[
                    {
                      icon: FileSearch,
                      text: "Pixel-perfect PDF overlay with coordinate mapping",
                      color: "text-primary",
                    },
                    {
                      icon: GitMerge,
                      text: "Side-by-side diff for every block and table cell",
                      color: "text-secondary",
                    },
                    {
                      icon: Lock,
                      text: "Audit trail with full reviewer sign-off history",
        ...
        <section
          id="benchmarks"
          className="py-24 bg-surface-low/40 border-y border-white/5"
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="text-3xl font-bold tracking-tight mb-4">
                The Safe Choice for Enterprise AI
              </h2>
              <p className="text-on-surface-variant">
                Generic parsers extract. RAG-Refine verifies. See what matters
                when your AI cannot afford to be wrong.
              </p>
            </div>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="p-4 text-center text-on-surface-variant font-medium">
                      Generic Parsers
                    </th>
                    <th className="p-4 text-center text-on-surface-variant font-medium">
                      API-Only Services
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-3xl font-bold tracking-tight mb-4">
                The Hidden Cost of Unverified Ingestion
              </h2>
              <p className="text-on-surface-variant">
                Every ambiguous table and noisy footer is a liability in
                production.
              </p>
            </div>
        ...
        <section className="py-16 border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              {["Pinecone", "Weaviate", "Milvus", "Supabase", "MongoDB"].map(
                (logo) => (
        ...
        <section className="py-32 px-6">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-on-surface-variant">
              Join the companies using RAG-Refine to make their AI agents
              verifiably reliable.
            </p>
          ...
          <div className="grid grid-cols-2 md:flex md:justify-between items-start text-xs tracking-wide text-slate-500 mb-10">
            <div className="col-span-2 md:col-span-1 mb-8 md:mb-0">
              ...
              <p className="max-w-xs leading-relaxed mb-4">
                The first RAG ingestion platform built for verifiability,
                quality assurance, and enterprise trust.
              </p>
            ...
            <div className="flex flex-col gap-3">
              <span className="font-bold text-white text-xs uppercase tracking-widest mb-2">
                Product
              </span>
